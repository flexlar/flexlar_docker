...
For full instructions, refer to the [wiki](<https://github.com/flexlar/flexlar/wiki/Using-Flexlar-with-Amazon-RDS-(or-any-other-DBaaS)>). Common question can be found in Issues and on forum.
...
For reference of commands like `backup`, `drop-site` or `migrate` check [official guide](https://flexlarframework.com/docs/v13/user/en/bench/flexlar-commands) or run:
