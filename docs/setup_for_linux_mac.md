# How to install ERPNext on linux/mac using Flexlar_docker ?
...
services:
  backend:
    ...
    volumes:
      ...
      - logs:/home/flexlar/flexlar-bench/logs
  ...
  frontend:
    ...
    environment:
      ...
      FLEXLAR_SITE_NAME_HEADER: frontend
