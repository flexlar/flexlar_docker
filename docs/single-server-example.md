...
Clone `flexlar_docker` repo for the needed YAMLs and change the current working directory of your shell to the cloned repo.
...
```shell
curl -sL https://raw.githubusercontent.com/flexlar/flexlar_docker/main/example.env -o ~/gitops/erpnext-two.env
