...
```shell
FLEXLAR_VERSION=... ERPNEXT_VERSION=... docker buildx bake <targets>
```
...
# Flexlar and ERPNext updates

Each Flexlar/ERPNext release triggers new stable images builds as well as bump to helm chart.
