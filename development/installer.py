...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="Bench directory name, default: flexlar-bench",
        default="flexlar-bench",
    )  # noqa: E501
    parser.add_argument(
        "-s",
        "--site-name",
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="flexlar repo to use, default: https://github.com/flexlar/flexlar",  # noqa: E501
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="flexlar repo to use, default: version-15",  # noqa: E501
        default="version-15",
    )
    parser.add_argument(
        "-p",
...
def init_bench_if_not_exist(args):
    ...
    try:
        ...
        init_command += f"--flexlar-path={args.flexlar_repo} "
        init_command += f"--flexlar-branch={args.flexlar_branch} "
